...
import com.emirim.hyejin.mokgongso.fragment.recyclerview.InnerViewHolder
import com.emirim.hyejin.mokgongso.fragment.recyclerview.InnterItem
import com.emirim.hyejin.mokgongso.model.DRe
import com.emirim.hyejin.mokgongso.model.Diary
...
class DiaryFragment : Fragment() {
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        (containtLayout.diaryRecyclerView.adapter as MyAdapter).onSaveInstanceState(outState)
    }
...
//        adapter.notifyDataSetChanged()
        //adapter.bindViewHolder(InnerViewHolder(containtLayout), 0)
 /*           adapter.notifyItemInserted(1)
        adapter.notifyItemInserted(2)
*/
        containtLayout.diaryRecyclerView.adapter = adapter
